...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getDateFromToday": () => (/* binding */ getDateFromToday),
...
/* harmony export */   "isLate": () => (/* binding */ isLate)
/* harmony export */ });
...
function getDateFromToday(numDays) {
    ...
    if (numDays > 0) {         // Get date in the future
        date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.default)(today, {days: numDays});
    } else if (numDays == 0) { // Get today 
        date = today;
    } else {                   // Get date in the past
        date = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(today, {days: Math.abs(numDays)});
    }
...
function getDiffFromToday(date) {
    const today = new Date();
    const diff = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)(date), today);
    return diff;
}
...
function getRelativeDate(taskDueDate) {
    ...
    if (diff < -1) {                     // Due in the past
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)(taskDueDate), "MMM d");
        ...
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)(taskDueDate), "EEEE");
    } else if (diff > 7 && diff < 365) { // Due this year
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)(taskDueDate), "MMM d");
    } else {                             // Due in more than a year
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)(taskDueDate), "MMM d y");
    }
}
...
/* harmony export */   "displayUserProjects": () => (/* binding */ displayUserProjects),
...
function displayTasks(project, sort) {
    ...
    if (project === "Today") {
        tasks = (0,_storageManager__WEBPACK_IMPORTED_MODULE_0__.getTasks)().filter(task => (0,_date__WEBPACK_IMPORTED_MODULE_1__.dueToday)(task.dueDate));
    } else if (project === "This Week") {
        tasks = (0,_storageManager__WEBPACK_IMPORTED_MODULE_0__.getTasks)().filter(task => (0,_date__WEBPACK_IMPORTED_MODULE_1__.dueThisWeek)(task.dueDate));
    } else {
        tasks = (0,_storageManager__WEBPACK_IMPORTED_MODULE_0__.getTasks)().filter(task => task.project === project);
    }
    ...
    for (const task of tasks) {
        ...
        taskCheck.addEventListener("click", () => {
            (0,_storageManager__WEBPACK_IMPORTED_MODULE_0__.deleteTask)(task.id);
        ...
        taskDueDate.textContent = (0,_date__WEBPACK_IMPORTED_MODULE_1__.getRelativeDate)(task.dueDate);
        if ((0,_date__WEBPACK_IMPORTED_MODULE_1__.isLate)(task.dueDate)) taskDueDate.classList.add("late");
...
function displayUserProjects() {
    ...
    const userProjects = (0,_storageManager__WEBPACK_IMPORTED_MODULE_0__.getUserProjects)();
...
function generateTasks() {
    ...
    tasks.push((0,_task__WEBPACK_IMPORTED_MODULE_0__.taskFactory)("Clean room", 3, (0,_date__WEBPACK_IMPORTED_MODULE_1__.getDateFromToday)(-4), "Inbox"));
    tasks.push((0,_task__WEBPACK_IMPORTED_MODULE_0__.taskFactory)("Laundry", 2, (0,_date__WEBPACK_IMPORTED_MODULE_1__.getDateFromToday)(0), "Inbox"));
    tasks.push((0,_task__WEBPACK_IMPORTED_MODULE_0__.taskFactory)("Taxes", 1, (0,_date__WEBPACK_IMPORTED_MODULE_1__.getDateFromToday)(4), "Inbox"));
    tasks.push((0,_task__WEBPACK_IMPORTED_MODULE_0__.taskFactory)("Vacation", 2, (0,_date__WEBPACK_IMPORTED_MODULE_1__.getDateFromToday)(400), "Inbox"));

    // School (user project)
    tasks.push((0,_task__WEBPACK_IMPORTED_MODULE_0__.taskFactory)("Study for exam", 4, (0,_date__WEBPACK_IMPORTED_MODULE_1__.getDateFromToday)(10), "School"));
    tasks.push((0,_task__WEBPACK_IMPORTED_MODULE_0__.taskFactory)("Math problems", 2, (0,_date__WEBPACK_IMPORTED_MODULE_1__.getDateFromToday)(-1), "School"));
    tasks.push((0,_task__WEBPACK_IMPORTED_MODULE_0__.taskFactory)("History reading", 3, (0,_date__WEBPACK_IMPORTED_MODULE_1__.getDateFromToday)(1), "School"));
    tasks.push((0,_task__WEBPACK_IMPORTED_MODULE_0__.taskFactory)("Final presentation", 1, (0,_date__WEBPACK_IMPORTED_MODULE_1__.getDateFromToday)(40), "School"));

    // Groceries (user project)
    tasks.push((0,_task__WEBPACK_IMPORTED_MODULE_0__.taskFactory)("Milk", 4, "", "Groceries"));
    tasks.push((0,_task__WEBPACK_IMPORTED_MODULE_0__.taskFactory)("Eggs", 4, "", "Groceries"));
    tasks.push((0,_task__WEBPACK_IMPORTED_MODULE_0__.taskFactory)("Cheese", 4, "", "Groceries"));
...
function firstLoad() {
    ...
    if (tasks === null) {
        ...
        tasks = (0,_example__WEBPACK_IMPORTED_MODULE_1__.generateTasks)();
...
function addTask(name, priority, dueDate, project) {
    const newTask = (0,_task__WEBPACK_IMPORTED_MODULE_0__.taskFactory)(name, priority, dueDate, project);
    tasks.push(newTask);
    localStorage.setItem("tasks", JSON.stringify(tasks));
}
...
(0,_storageManager__WEBPACK_IMPORTED_MODULE_0__.firstLoad)();
(0,_display__WEBPACK_IMPORTED_MODULE_1__.displayUserProjects)();
(0,_display__WEBPACK_IMPORTED_MODULE_1__.displayTasks)("Inbox", "Due date");
...
addTaskBtn.addEventListener("click", () => {
    (0,_display__WEBPACK_IMPORTED_MODULE_1__.updateProjDropdown)("#new-task-project");
...
for (let proj of defaultProjects) {
    proj.addEventListener("click", function () {
        (0,_display__WEBPACK_IMPORTED_MODULE_1__.displayTasks)(proj.dataset.name, "Due date");
    });
}
...
document.querySelector("#demo-blank").addEventListener("click", () => {
    (0,_storageManager__WEBPACK_IMPORTED_MODULE_0__.deleteAll)();
    (0,_display__WEBPACK_IMPORTED_MODULE_1__.displayUserProjects)();
    (0,_display__WEBPACK_IMPORTED_MODULE_1__.displayTasks)("Inbox", "Due date");
});
...
sortSelect.addEventListener("change", (e) => {
    ...
    (0,_display__WEBPACK_IMPORTED_MODULE_1__.displayTasks)(curProject, sort);
});
...
document.querySelector("#new-task-form").addEventListener("submit", (event) => {
    ...
    (0,_storageManager__WEBPACK_IMPORTED_MODULE_0__.addTask)(taskName, taskPriority, taskDueDate, taskProject);

    (0,_display__WEBPACK_IMPORTED_MODULE_1__.resetForms)();
    const curProject = document.querySelector("#cur-project-name").textContent;
    const curSort = document.querySelector("#sort-select").value;
    (0,_display__WEBPACK_IMPORTED_MODULE_1__.displayTasks)(curProject, curSort);
});
...
document.querySelector("#new-project-name").addEventListener("input", () => {
    ...
    const projects = ["Inbox", "Today", "This Week"].concat((0,_storageManager__WEBPACK_IMPORTED_MODULE_0__.getUserProjects)());
...
document.querySelector("#new-project-form").addEventListener("submit", (event) => {
    ...
    const projName = document.querySelector("#new-project-name").value.trim();
    (0,_storageManager__WEBPACK_IMPORTED_MODULE_0__.addProject)(projName);
...
document.querySelector("#edit-project-form").addEventListener("submit", (event) => {
    ...
    const curName = document.querySelector("#cur-project-name").textContent;
    const editName = document.querySelector("#edit-project-name").value.trim();
    (0,_storageManager__WEBPACK_IMPORTED_MODULE_0__.editProject)(curName, editName);

    (0,_display__WEBPACK_IMPORTED_MODULE_1__.resetForms)();
    (0,_display__WEBPACK_IMPORTED_MODULE_1__.displayUserProjects)();
    (0,_display__WEBPACK_IMPORTED_MODULE_1__.displayTasks)(editName, document.querySelector("#sort-select").value);
});
...
document.querySelector("#edit-project-delete").addEventListener("click", () => {
    ...
    if (delConfirm) {
        (0,_storageManager__WEBPACK_IMPORTED_MODULE_0__.deleteProject)(projName);
        (0,_display__WEBPACK_IMPORTED_MODULE_1__.resetForms)();
        (0,_display__WEBPACK_IMPORTED_MODULE_1__.displayUserProjects)();
        (0,_display__WEBPACK_IMPORTED_MODULE_1__.displayTasks)("Inbox", "Due date");
    }
...
editTaskForm.addEventListener("submit", (event) => {
    event.preventDefault();
    (0,_storageManager__WEBPACK_IMPORTED_MODULE_0__.editTask)(editTaskForm.dataset.id, editTaskName.value.trim(), editTaskPriority.value,
...
document.querySelector("#edit-task-delete").addEventListener("click", () => {
    ...
    if (delConfirm) {
        (0,_storageManager__WEBPACK_IMPORTED_MODULE_0__.deleteTask)(editTaskForm.dataset.id);
        resetEditFlags();
        (0,_display__WEBPACK_IMPORTED_MODULE_1__.resetForms)();
        const curProject = document.querySelector("#cur-project-name").textContent;
        const curSort = document.querySelector("#sort-select").value;
